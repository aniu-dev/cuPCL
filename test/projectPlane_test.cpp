 ...
 */
pcl::PointCloud<pcl::PointXYZ>::Ptr generateRandomCloudPlane(size_t num_points, float range = 100.0f) {
...
void projectPlane_test(size_t numPoints, float range)
{
    ...
    cloud = generateRandomCloudPlane(numPoints, range);
    ...
    plane_coeff->values[0] = plane_coeff->values[2] = 0;
    ...
    std::cout << "[PCL] projectPlane Time: " << pcl_time << " ms " << "\n";
    std::cout << "[GPU] projectPlane Time: " << gpu_all_time / (test_num - 1) << " ms " << "\n";
